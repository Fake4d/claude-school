...
definitions inside the program itself. As of version 2.1.260 — 64 options,
134 available slash commands, 5 present but switched off. A scheduled job keeps it
