...
definitions inside the program itself. As of version 2.1.268 — 64 options,
133 available slash commands, 5 present but switched off. A scheduled job keeps it
