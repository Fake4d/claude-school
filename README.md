...
definitions inside the program itself. As of version 2.1.245 — 62 options,
127 available slash commands, 5 present but switched off. A scheduled job keeps it
