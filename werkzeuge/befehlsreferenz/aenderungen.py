...
neue noch weggefallene Befehle, keine geänderten Beschreibungen. Bei 33 Befehlen haben sich nur
...
no additions, no removals, no description changes. 33 commands had only internal, non-visible
