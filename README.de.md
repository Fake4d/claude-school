...
| [**Loop Engineering als Comic**](loop-comic/loop-anleitung.pdf) | 17 Seiten | Special — Bonusheft zu Stufe 3: `/loop`, `/goal` und `/schedule` als ein Paket, bis hin zur proaktiven Schleife | [PDF](loop-comic/loop-comic-en.pdf) |
...
Befehlsdefinitionen im Programm selbst. Stand: Version 2.1.281 — 64 Optionen,
135 verfügbare Slash-Befehle, 5 angelegt aber abgeschaltet. Ein Zeitplan-Auftrag hält
