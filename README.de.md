...
| [**Loop Engineering als Comic**](loop-comic/loop-anleitung.pdf) | 18 Seiten | Special — Bonusheft zu Stufe 3: `/loop`, `/goal` und `/schedule` als ein Paket, bis hin zur proaktiven Schleife | [PDF](loop-comic/loop-comic-en.pdf) |
